/*
Author: DESS - Chennai
Description: Reusable validation services - Angular1
Services:'validatorsService'
Version: 1.0.0
*/

// Usage - 
// 1. Replace the app in app.service with your module name (or) put this service into a define function if you are using requireJS in your application
// 2. Inject the service in your controller and access the validators function (Pass the parameters (i.e) value etc... to the validator functions and value is mandatory for all the validators functions)
// 3. Returns true if there is no validation failures
// 4. Returns false or the default message templates if there is validation failures
// 5. If you send the label value as the parameter, then it will return the message template with the label

app.service('validatorsService', function() {
